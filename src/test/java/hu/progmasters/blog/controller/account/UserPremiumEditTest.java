...
@Transactional
public class UserPremiumEditTest {
    ...
    private static final String USER_PROFILE_PREMIUM_ENDPOINT = ACCOUNT_MAPPING + "/profile/premium/1";
    private static final String USER_PROFILE_NOT_EXIST_PREMIUM_ENDPOINT = ACCOUNT_MAPPING + "/profile/premium/2";
    @Test
    void test_newsletterSubscribeSuccessful() throws Exception {
        ...
        String inputCommand = "{\n" +
                "    \"premium\": true \n" +
                "}";
        mockMvc.perform(put(USER_PROFILE_PREMIUM_ENDPOINT)
    ...
    void test_profilNotExist() throws Exception {
        ...
        String inputCommand = "{\n" +
                "    \"newsletter\": false \n" +
                "}";
        mockMvc.perform(put(USER_PROFILE_NOT_EXIST_PREMIUM_ENDPOINT)
                        .with(user("TestUser").password("testPassword").roles("USER"))
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                        .content(inputCommand))
